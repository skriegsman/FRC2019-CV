...
def detectTape(frame):
    #whiteRange - A range of HSV values that count as "white"
    whiteRange = np.array([[0, 0, 200], [255, 50, 255]])
    tape = [] #Empty list to be filled with tape contours
...
"""
#New VideoCapture object using camera 0 named cap
cap = cv2.VideoCapture(0)
#initialize a networktable on rasppifront server
